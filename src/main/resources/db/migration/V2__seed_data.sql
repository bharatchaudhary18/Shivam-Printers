...
('Graphic Design', 'graphic-design', 'Professional graphic design for all your branding needs.', 'Creative visual solutions for modern brands.', 'palette', 2999.00, true, 1),
('Logo Design', 'logo-design', 'Memorable logo designs that define your brand identity.', 'Distinctive logos crafted with precision.', 'sparkles', 4999.00, true, 2),
('Banner Design', 'banner-design', 'Eye-catching banners for events, shops, and promotions.', 'High-impact banner designs.', 'flag', 1499.00, true, 3),
('Flex Printing', 'flex-printing', 'Premium flex printing for hoardings and signage.', 'Durable flex prints with vivid colors.', 'printer', 899.00, false, 4),
('Visiting Cards', 'visiting-cards', 'Elegant visiting cards with premium finishes.', 'Make a lasting first impression.', 'id-card', 599.00, true, 5),
('Wedding Cards', 'wedding-cards', 'Luxurious wedding invitation cards and stationery.', 'Celebrate your special day in style.', 'heart', 3999.00, true, 6),
('Brochure Design', 'brochure-design', 'Professional brochures that tell your brand story.', 'Informative and visually stunning brochures.', 'book-open', 2499.00, false, 7),
('Packaging Design', 'packaging-design', 'Creative packaging that stands out on shelves.', 'Product packaging that sells.', 'package', 5999.00, false, 8),
('Digital Printing', 'digital-printing', 'Fast, high-quality digital printing services.', 'Quick turnaround digital prints.', 'monitor', 499.00, false, 9),
('Offset Printing', 'offset-printing', 'Large volume offset printing with superior quality.', 'Cost-effective bulk printing.', 'layers', 1999.00, false, 10),
('Social Media Post Design', 'social-media-post-design', 'Engaging social media creatives for all platforms.', 'Scroll-stopping social content.', 'share-2', 999.00, true, 11),
('Custom Printing', 'custom-printing', 'Fully customized printing solutions for unique requirements.', 'Tailored to your exact specifications.', 'settings', 0.00, false, 12);
